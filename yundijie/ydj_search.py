...
conn.request(method = "GET", url = "http://yundijie.com/search/addresses?offset=0&limit=50&input=Asia%20Hotel%20Bangkok&cityId=230&location=13.689999,100.750112", headers =  headers)
...
if response.status == 200:
    ...
    for i in range(len(datas['data']['places'])):
        print(datas['data']['places'][i])
        spiderdata.insert_one(datas['data']['places'][i])
